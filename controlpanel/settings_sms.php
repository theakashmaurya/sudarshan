...
<head>
  ...
  <title>SMS Notification Setting - Sudarshan</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="settings_sms.php"><i class="fa fa-info-envelope"></i>SMS Notifications</a>
        </li>
        <li class="nav-item">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <p class="text-danger">Service Not Available ! Update to a newer version</p>
        </div>
    </div>
    <!-- /.container-fluid-->
    <!-- /.content-wrapper-->
